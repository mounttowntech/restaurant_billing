...
exports.deleteKOT = async (req, res) => {
  try {
    ...
    await kot.softDelete(req.user?.id);
...
exports.getKitchenQueue = async (req, res) => {
  try {
    const data = await KOT.getKitchenQueue();
...
exports.getChefOrders = async (req, res) => {
  try {
    const data = await KOT.getChefOrders(req.params.chefId);
...
exports.getPendingKOTs = async (req, res) => {
  try {
    const data = await KOT.getPendingKOTs();
...
exports.getTodayKOTs = async (req, res) => {
  try {
    const data = await KOT.getTodayKOTs();
